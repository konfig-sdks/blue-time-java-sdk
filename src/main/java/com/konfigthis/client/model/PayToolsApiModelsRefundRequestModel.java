 ...
 */
@ApiModel(description = "Model for UPG refund operation")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class PayToolsApiModelsRefundRequestModel {
  ...
  public PayToolsApiModelsRefundRequestModel() {
  }

  public PayToolsApiModelsRefundRequestModel currency(String currency) {
  ...
  **/
  ...
  public PayToolsApiModelsRefundRequestModel refTransId(String refTransId) {
  ...
  **/
  ...
  public PayToolsApiModelsRefundRequestModel payerDetails(PayToolsApiModelsPayerDetails payerDetails) {
  ...
  **/
  ...
  public PayToolsApiModelsRefundRequestModel card(PayToolsApiModelsCardInputModel card) {
  ...
  **/
  ...
  public PayToolsApiModelsRefundRequestModel amount(Double amount) {
  ...
  **/
  ...
  public PayToolsApiModelsRefundRequestModel myRef(String myRef) {
  ...
  **/
  ...
  public PayToolsApiModelsRefundRequestModel paymentGatewayAccountName(String paymentGatewayAccountName) {
  ...
  **/
  ...
  public PayToolsApiModelsRefundRequestModel certificateName(String certificateName) {
  ...
  **/
  ...
  public PayToolsApiModelsRefundRequestModel paymentGatewayAccount(PayToolsApiModelsPaymentGatewayAccount paymentGatewayAccount) {
  ...
  **/
  ...
  public PayToolsApiModelsRefundRequestModel networkTokenBrand(PaymentsNetworkTokenSchemes networkTokenBrand) {
  ...
  **/
   ...
   * @return the PayToolsApiModelsRefundRequestModel instance itself
   */
  public PayToolsApiModelsRefundRequestModel putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PayToolsApiModelsRefundRequestModel payToolsApiModelsRefundRequestModel = (PayToolsApiModelsRefundRequestModel) o;
    return Objects.equals(this.currency, payToolsApiModelsRefundRequestModel.currency) &&
        Objects.equals(this.refTransId, payToolsApiModelsRefundRequestModel.refTransId) &&
        Objects.equals(this.payerDetails, payToolsApiModelsRefundRequestModel.payerDetails) &&
        Objects.equals(this.card, payToolsApiModelsRefundRequestModel.card) &&
        Objects.equals(this.amount, payToolsApiModelsRefundRequestModel.amount) &&
        Objects.equals(this.myRef, payToolsApiModelsRefundRequestModel.myRef) &&
        Objects.equals(this.paymentGatewayAccountName, payToolsApiModelsRefundRequestModel.paymentGatewayAccountName) &&
        Objects.equals(this.certificateName, payToolsApiModelsRefundRequestModel.certificateName) &&
        Objects.equals(this.paymentGatewayAccount, payToolsApiModelsRefundRequestModel.paymentGatewayAccount) &&
        Objects.equals(this.networkTokenBrand, payToolsApiModelsRefundRequestModel.networkTokenBrand)&&
        Objects.equals(this.additionalProperties, payToolsApiModelsRefundRequestModel.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(currency, refTransId, payerDetails, card, amount, myRef, paymentGatewayAccountName, certificateName, paymentGatewayAccount, networkTokenBrand, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PayToolsApiModelsRefundRequestModel {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PayToolsApiModelsRefundRequestModel
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PayToolsApiModelsRefundRequestModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PayToolsApiModelsRefundRequestModel is not found in the empty JSON string", PayToolsApiModelsRefundRequestModel.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PayToolsApiModelsRefundRequestModel.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PayToolsApiModelsRefundRequestModel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PayToolsApiModelsRefundRequestModel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PayToolsApiModelsRefundRequestModel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PayToolsApiModelsRefundRequestModel.class));

       return (TypeAdapter<T>) new TypeAdapter<PayToolsApiModelsRefundRequestModel>() {
           @Override
           public void write(JsonWriter out, PayToolsApiModelsRefundRequestModel value) throws IOException {
           ...
           @Override
           public PayToolsApiModelsRefundRequestModel read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PayToolsApiModelsRefundRequestModel instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PayToolsApiModelsRefundRequestModel given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PayToolsApiModelsRefundRequestModel
  * @throws IOException if the JSON string is invalid with respect to PayToolsApiModelsRefundRequestModel
  */
  public static PayToolsApiModelsRefundRequestModel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PayToolsApiModelsRefundRequestModel.class);
  }

 /**
  * Convert an instance of PayToolsApiModelsRefundRequestModel to an JSON string
  *
  * @return JSON string
  */
